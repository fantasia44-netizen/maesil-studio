...
def _register_hooks(app):
    ...
    def security_headers(response):
        ...
        csp = (
            ...
            "developers.kakao.com *.kakao.com; "
            "media-src 'self' blob: *.supabase.co *.supabase.in "
            "*.fal.media fal.media; "
            "connect-src 'self' *.supabase.co *.supabase.in "
            "cdn.jsdelivr.net cdnjs.cloudflare.com "
            "cdn.portone.io *.portone.io api.portone.io *.iamport.kr "
            "*.inicis.com *.kcp.co.kr *.tosspayments.com "
            "*.kakao.com *.kakaopay.com *.kakaocdn.net "
            "*.naver.com *.naverpay.com "
            "*.ksnet.co.kr *.uplus.co.kr *.danal.co.kr "
            "*.nicepay.co.kr *.hecto.co.kr; "
            "frame-src *.portone.io *.iamport.kr "
            "*.inicis.com *.kcp.co.kr *.tosspayments.com "
            "*.kakao.com *.kakaopay.com "
            "*.naver.com *.naverpay.com "
            "*.ksnet.co.kr *.uplus.co.kr *.danal.co.kr "
            "*.nicepay.co.kr *.hecto.co.kr; "
