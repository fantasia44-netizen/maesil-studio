...
def generate_scene(mascot_urls, topic: str, user_id: str = 'anon',
    ...
    if urls:
        ...
        prompt = (
            ...
            f'IMPORTANT: leave only the TOP ~30% of the image as clean empty space of that background '
            f'color for a title. Make the mascot and scene LARGE and prominent, filling the lower '
            f'two-thirds of the image (do not leave a big empty gap under the title). '
        ...
        prompt = (
            ...
            f'Paint the whole square background as a soft flat {bg_phrase} color palette with gentle shapes. '
            f'Leave only the TOP ~30% of the image as clean empty space of that background color for a title. '
            f'Make the objects LARGE and prominent, filling the lower two-thirds of the image '
            f'(do not leave a big empty gap under the title). '
            f'Bright cheerful colors, thick clean black outlines, korean kids storybook sticker style, '
            f'square 1:1 composition. '
            f'CRITICAL: render absolutely NO text anywhere — no letters, words, numbers, labels, '
            f'brand names, logos, signage, captions or writing on any object, sign, screen, box or surface. '
