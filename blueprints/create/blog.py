...
def blog_image_prompts():
    ...
    system_prompt = (
        ...
        ''
        'RULE 4 — No text surfaces: NEVER describe sticky notes on walls, bulletin boards with notes, '
        'whiteboards with writing, posters with text, or boxes/packages with visible labels. '
        'These cause FLUX to render garbled CJK characters. '
        'Instead say "cozy home office background" or "shelves with boxes" without mentioning text/labels. '
        ''
