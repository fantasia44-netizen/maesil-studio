...
def blog_image_prompts():
    ...
    system_prompt = (
        ...
        '━━ ABSOLUTE RULES (violation causes image corruption) ━━ '
        'RULE 1: The "prompt" field MUST be English ONLY. NEVER write Korean/Japanese/Chinese. '
        'RULE 2: NEVER describe what is displayed ON a screen, tablet, or phone. '
        '  BAD: "working on product listing on a tablet" '
        '  GOOD: "holding a tablet, focused expression, cozy home office" '
        '  BAD: "smartphone showing e-commerce app" '
        '  GOOD: "using a smartphone, warm lifestyle scene" '
        '  Any on-screen content description causes FLUX to render corrupted text artifacts. '
        'RULE 3: If a device (tablet/phone/laptop/computer) appears, describe ONLY the device exterior and the person using it — NEVER its screen content. '
