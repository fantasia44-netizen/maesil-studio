...
def blog_image_prompts():
    ...
    system_prompt = (
        ...
        ''
        'RULE 4 — Flat-lay ban: NEVER create flat-lay / top-down product shots unless explicitly requested. '
        'Lifestyle scenes must show a REAL PERSON interacting with the environment. '
        ''
